...
DEBUG ?= 0
ifeq ($(DEBUG), 1)
    CPPFLAGS = -Wall -g -fPIC -std=c++11 -I$(INCDIR) -D VIEW_MODULE_VERSION=\"$(VERSION)\" -D _DEBUG -O0
else
    CPPFLAGS = -Wall -g -fPIC -std=c++11 -I$(INCDIR) -D VIEW_MODULE_VERSION=\"$(VERSION)\" -D NDEBUG -O3
endif
